...
interface HPVAccessionFormProps {
  setCurrentView: (view: string) => void;
}

const HPVAccessionForm = ({ setCurrentView }: HPVAccessionFormProps) => {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => setImage1(reader.result as string);
  ...
  const handleCreateSample = async () => {
    ...
    try {
      ...
      if (response.ok) {
        alert("HPV Sample successfully uploaded!");
      ...
      <div className="flex items-center justify-between mb-8 border-b pb-6">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Register new HPV sample with patient details and image.
          </p>
        </div>
        ...
        <CardContent className="p-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div className="col-span-full">
              <p className="text-[11px] font-black text-purple-600 uppercase tracking-[0.2em] mb-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none transition-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-lg font-mono focus:ring-2 focus:ring-purple-500 outline-none"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none"
              >
            ...
            <div className="col-span-full pt-4 mt-2 border-t border-slate-100">
              ...
              <div className="space-y-2 max-w-sm">
                ...
                <div
                  className={`border-2 border-dashed rounded-xl p-4 text-center transition-all ${image1 ? "border-purple-500 bg-purple-50" : "border-slate-200 bg-slate-50"}`}
                >
                  {image1 ? (
                    ...
                    <div className="py-4">
                      ...
                      <input
                        ...
                        className="text-[10px] block w-full text-slate-500 file:mr-4 file:py-1 file:px-2 file:rounded-full file:border-0 file:text-xs file:bg-purple-50 file:text-purple-700"
                      />
                    </div>
                  )}
                </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none"
                />
              </div>
            </div>
            ...
            <div className="col-span-full space-y-2">
              ...
              <div className="grid grid-cols-3 gap-4">
                <select
                  ...
                  className="p-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none"
                >
            ...
            {/* Notes (instead of Clinical History) */}
            <div className="col-span-full space-y-2">
              ...
              <textarea
                ...
                className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none min-h-[100px] transition-all"
              />
            </div>
          ...
          <div className="mt-12">
            <Button
              ...
              className="w-full py-7 text-lg font-bold bg-purple-600 hover:bg-purple-700 text-white rounded-xl shadow-xl transition-transform active:scale-95 disabled:bg-slate-300"
            >
              <PlusCircle className="mr-2 h-6 w-6" /> Complete HPV Accession
            </Button>
...
export default HPVAccessionForm;
